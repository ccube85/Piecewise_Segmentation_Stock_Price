...
def draw_window(my_dpi, data, max_error):
    ...
    try:
        ...
        segments = segment.slidingwindowsegment(volume, fit.interpolate, fit.sumsquared_error, max_error)
        draw_plot(volume,plt,ax1,"Sliding window with interpolation")
        ...
        #First subplot volume

        # Second subplot
        ax2 = plt.subplot2grid((3, 3), (1, 0), colspan=3)
        segments = segment.topdownsegment(volume, fit.interpolate, fit.sumsquared_error, max_error)
        draw_plot(volume, plt, ax2, "Top down with interpolation")
        ...
        segments = segment.bottomupsegment(volume, fit.interpolate, fit.sumsquared_error, max_error)
        draw_plot(volume, plt, ax3, "Bottom up with interpolation")
