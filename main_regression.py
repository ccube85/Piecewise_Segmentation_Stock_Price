...
def draw_window(my_dpi, data, max_error):
    ...
    fig = plt.figure(figsize=(1240/my_dpi, 700/my_dpi), dpi=96, edgecolor='k', facecolor='black')
    fig.suptitle("PIECEWISE SEGMENTATION REGRESSION", fontsize="15", color="white")
